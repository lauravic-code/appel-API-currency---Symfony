...
class ExchangeRate
{
    ...
    {
        return $this->convertCurrency($euroPrice,"EUR","USD");


    }
    public function convertEurToYen(float $euroPrice): float
    {
        return $this->convertCurrency($euroPrice,"EUR","JPY");
    }

    private function convertCurrency(float $amount, string $entryCurrency, string $outCurrency ):float
    {
